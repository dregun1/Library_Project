        ...
        <div class="shareContentWrap">
            <div class="shareNav">
                <ul>
                    ...
                    <li><span class="keyword"><a href="/book/InterestedBooks">내 관심도서</a></span></li>
            ...
            <div class="shareContentBox">
                <div class="shareContentTitle">
                    <div class="contentTitle">내 관심도서</div>
                ...
                <div class="shareContent">
                    <c:forEach var="book" items="${ interestedList }">
                    <div class="listWrap">
                        ...
                        <div class="listContentBox">
					    	...
					    	<div class="listBtnBox">
	                            ...
	                            <input type="button" value="삭제하기" onclick="interestedDelete('${book.wishlistid}')" >
                     		</div>
                    </div>
                	</c:forEach>
                	<br>
                 	<!-- 페이징 처리  -->
                	<form id='actionform' action="/book/InterestedBooks" method="get">
						<div class="paging">
						  <ul >
...
<script>
	...
	function interestedDelete(wishlistid) {
        $.ajax({
            type: 'GET',
            url: '/book/interestedDelete',
