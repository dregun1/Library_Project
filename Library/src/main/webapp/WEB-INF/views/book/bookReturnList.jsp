        ...
        <div class="shareContentWrap">
            <div class="shareNav">
                <ul>
                    ...
                    <li><span class="keyword"><a href="/book/bookReturnList">반납현황 조회</a></span></li>
                </ul>
            </div>
            <div class="shareContentBox">
                <div class="shareContentTitle">
                    <div class="contentTitle">반납도서 조회</div>
                ...
                <div class="shareContent">
                    ...
                    <div class="listWrap">
                        ...
                        <div class="listContentBox">
                            ...
                            <p>반납기간 : ${book.actualreturndate}</p>
                            <!-- 본문 내용추가 원하면 여기에 추가 -->
                        </div>                        	
					       <div class="listBtnBox">
	                            <input type="button" value="반납완료" readonly="readonly" >
	                            <input type="button" value="삭제하기"  onclick="deleteReturn('${book.rentallistid}')">
                     		</div>						
                    </div>
                	</c:forEach>
...
<script>
		...
		function deleteReturn(rentallistid) {
		    $.ajax({
		        type:'GET',
		        url: '/book/deleteReturn',
