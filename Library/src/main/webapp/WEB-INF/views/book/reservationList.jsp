        ...
        <div class="shareContentWrap">
            <div class="shareNav">
                <ul>
                    ...
                    <li><span class="keyword"><a href="/book/reservationList">예약도서 조회</a></span></li>
            ...
            <div class="shareContentBox">
                <div class="shareContentTitle">
                    <div class="contentTitle">예약도서 조회</div>
                ...
                <div class="shareContent">
                    <c:forEach var="book" items="${ bookReservationList }">
                    <div class="listWrap">
                        ...
                        <div class="listContentBox">
                            ...
                            <p>예약만료날짜 : ${book.expiration_date}</p>
                            <!-- 본문 내용추가 원하면 여기에 추가 -->
                        </div>                        	
					       <div class="listBtnBox">
	                            <input type="button" value="대여 미완료" readonly="readonly" >
	                            <input type="button" value="예약 취소하기"  onclick="cancelReserve('${book.isbn}')">
                     		</div>						
                    </div>
                	</c:forEach>
