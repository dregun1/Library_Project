		...
		<div class="shareContentWrap">
			<div class="shareNav">
				<ul>
					...
					<li><span class="keyword"><a href="/book/bookTotalList">통합도서
								검색</a></span></li>
			...
			<div class="shareContentBox">
				...
				<div class="shareContent">
					<c:forEach var="book" items="${ bookSearchList }">
						<div class="listWrap">
							...
							<div class="listContentBox">
								<h2>
									<a href="/book/bookDetail?isbn=${book.isbn}">${book.title }</a>
								</h2>
								<h3>${book.author },${book.publisher },
									${book.publisheddate }</h3>
								<p>누적대여 횟수 : ${book.cumrentalcnt }, 대여가능 수량 :
									${book.curbookcnt }, 구독자 평점 : ${book.score }</p>
								<!-- 본문 내용추가 원하면 여기에 추가 -->
							</div>
							<sec:authorize access="isAnonymous()">
								<div class="listBtnBox">
									<input type="button" value="관심도서 추가"
										onclick="alert('로그인이 필요합니다.');"> <input type="button"
										value="예약하기" class="rentButton">
								</div>
							</sec:authorize>
					...
					<!-- 페이징 처리  -->
					<form id='actionform' action="/book/bookTotalList" method="get">
						<div class="paging">
							<ul>
