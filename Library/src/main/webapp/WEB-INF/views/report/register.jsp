						...
						<form method="post" action="/report/write">
						  ...
						  <table class="boardclass">
					        ...
					        <tr>
					            ...
					            <td>
					                <input class="boardinput" type="text" name="title" placeholder="제목" />
					            </td>
					        </tr>
					        <tr>
					            <td><label>작	가  </label></td>
					            <td>
					                <input class="boardinput" type="text" name="author" placeholder="작가" />
					            </td>
					        </tr>
					        <tr>
					            <td><label>평	점	</label></td>
					            <td>
					                <input class="boardinput" type="number" name="score" placeholder="평점" min="1" max="5" />
					            </td>
					        </tr>
					    </table>
										    <br><br>
				
					      <textarea class="bcontent" name="content"></textarea>
