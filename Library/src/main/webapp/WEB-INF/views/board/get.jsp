				...
				<br><br>
					...
					<table class="boardclass">
					    <tr>
					        ...
					        <td><input class="boardinput" value="${board.memberid}" readonly="readonly"></td>
					    </tr>
					    <tr>
					        <td><label>작성일  </label></td>
					        <td><input class="boardinput" value="${board.createdate}" readonly="readonly"></td>
					    </tr>
					    <tr>
					        <td><label>제	목  </label></td>
					        <td><input class="boardinput" value="${board.btitle}" readonly="readonly"></td>
					    </tr>
					    <tr>
					        <td><label>조회수 </label></td>
					        <td><input class="boardinput" value="${board.readcnt}" readonly="readonly"></td>
					    </tr>
					</table>
