		...
		<div class="shareContentWrap">
			...
			<div class="shareContentBox">
				...
				<div class="shareContent">
					<form action="/manager/bookUpdate" method="post" id="bookInsertForm"
						name="frm" enctype="multipart/form-data" class="bookInsertWrap">
						<table>
							<tr>
								<th>도서 제목</th>
								<td><input type="text" name="title" class="bookInsert" value="${book.title}" ></td>
							</tr>
							<tr>
								<th>ISBN</th>
								<td><input type="text" name="isbn" class="bookInsert" value="${book.isbn}" readonly="readonly"></td>
							</tr>
							<tr>
								<th>장르코드</th>
								<td><input type="text" name="genrecode" class="bookInsert" value="${book.genrecode}"></td>
							</tr>
							<tr>
								<th>도서분류</th>
								<td><input type="text" name="genrecrawled" class="bookInsert" value="${book.genrecrawled}"></td>
							</tr>
							<tr>
								<th>작가</th>
								<td><input type="text" name="author" class="bookInsert" value="${book.author}"></td>
							</tr>
							<tr>
								<th>출판사</th>
								<td><input type="text" name="publisher" class="bookInsert" value="${book.publisher}"></td>
							</tr>
							<tr>
								<th>출판일</th>
								<td><input type="text" name="publisheddate"
									class="bookInsert" value="${book.publisheddate}" placeholder="예시 : '2023-12-14'"></td>
							</tr>
							<tr>
								<th>도서가격</th>
								<td><input type="text" name="price" class="bookInsert" value="${book.price}"></td>
							</tr>
							<tr>
								<th>등록자</th>
								<td><input type="text" class="bookInsert" value="${book.memberid}" readonly="readonly"></td>
							</tr>
							<tr>
								<th>도서이미지정보</th>
							...
							<tr>
								...
								<td><textarea rows="15" cols="100" name="bookcontent"
										class="bookInsert" value="${book.bookcontent}"></textarea></td>
							</tr>
						</table>
