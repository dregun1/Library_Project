		...
		<div class="shareContentWrap">
			...
			<div class="shareContentBox">
				...
				<div class="submenu">
					<table>
						<tr>
							<th><a href="/manager/rentalManagement">현재대여</a></th>
							<th class="selectmenu"><a href="/manager/pastRentalManagement">지난대여</a></th>
						</tr>
					</table>
				</div>
						...
						<table>
							<c:forEach items="${list}" var="rental">
								<tr>
									...
									<td><c:out value="${rental.actualreturndate}" /></td>			
								</tr>
							</c:forEach>
						</table>
						<div>
							...
							<div class="searchform">
								<form id='actionform' action="/manager/pastRentalManagement" method="get">
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select
										name='type'>
										<option value=""
