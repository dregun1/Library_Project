		...
		<div class="shareContentWrap">
			...
			<div class="shareContentBox">
				...
				<div class="submenu">
					<table>
						<tr>
							<th class="selectmenu"><a href="/manager/GeneralMember">일반회원</a></th>
							<th><a href="/manager/ManagementMember">관리자회원</a></th>
						</tr>
					</table>
				</div>
						...
						<table>
							...
							<c:forEach items="${list}" var="member">
								<tr>
									...
									<td><input type="button" value="확인"  onclick="changeMemberflag('${member.memberid}')"></td>
								</tr>
							</c:forEach>
						</table>
						<div>
							...
							<div class="searchform">
								<form id='actionform' action="/manager/GeneralMember" method="get">
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select
										name='type'>
										<option value=""
...
function changeMemberflag(memberid) {
    $.ajax({
        type:'POST',
        url: '/manager/changeMemberflag',
        data: { memberid : memberid},
        success: function(response) {
        	alert("관리자 권한을 부여 하였습니다.");
            location.reload();
        },
